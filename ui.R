    ...
    sidebarLayout(
      ...
      mainPanel(tabsetPanel(
        ...
        tabPanel("Community Detection",
                 ...
                 selectInput("selectCD", label = h4("Community Detection Algorithm"),
                             choices = list("Girvan-Newman (edge betweenness)" = 1, "Clauset-Newman-Moore (fast greedy)" = 2), selected = 1)),
